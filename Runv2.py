...
def runModel(snr, cnr, noisy_areas, brain_areas, params, plot = False, prev_data_pred = None, prev_data_clas = None, seed = 0):
    ...
    EEG_data_test,  sources_test, noisy_sources_test, activity_test,  = importData(snr, cnr, noisy_areas, brain_areas, time_steps, trials, 0)

    
    #%%
    NeuralNets, train_pred, val_losses_pred, STOP_pred, optimizers_pred = fitProjectionModels(EEG_data_trainval, sources_trainval, noisy_sources_trainval, activity_trainval,
    ...
    #%%
    CNN_Nets, train_clas, val_losses_clas, STOP_clas, optimizers_clas = fitClassificationModels(EEG_data_trainval,sources_trainval,brain_areas,NeuralNets, clas_arch, kernel, stride,
    ...
    return [time_steps, trials, pred_arch[0], clas_arch[0], clas_arch[1], kernel[0], stride[0], lr_pred, lr_clas,
            ...
            STOP_pred_mean, STOP_clas_mean, area_accuracy, true_positive, true_negative, mean_mse, std_mse], NeuralNets, STOP_pred, CNN_Nets, STOP_clas, train_pred, train_clas, optimizers_pred, optimizers_clas