...
output_values = ["mse_pred", "mse_clas", "true_active_clas", 'true_noisy_clas', 'true_idle_clas', 'accuracy', "time", 'brain_area']
...
for brain_area in [115]:#, 231, 186, 310, 163, 463, 901, 588, 776, 696, 964, 843]:
    for comb in fixed_comb:
        ...
        for run in tqdm(range(runs)):
            ...
            beta_values = update_beta_values(output[0], 1 - output[5], param_values, run, beta_values, runs)
