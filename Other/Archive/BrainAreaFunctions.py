...
def train_brain_area(brain_area, param_values, val_perc = 0.1, plot = False, add_networks = False):
    ...
    if add_networks:
        data = (mse_pred, mse_clas, true_active_clas, true_noisy_clas, true_idle_clas, accuracy, STOP, STOP_clas, Net, CNN_Net, Validator, Validator_clas)
    else: 
        data = (mse_pred, mse_clas, true_active_clas, true_noisy_clas, true_idle_clas, accuracy, STOP, STOP_clas)
    return data
